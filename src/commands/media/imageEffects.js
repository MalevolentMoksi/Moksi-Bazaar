...
const blur = {
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(opt =>
            opt.setName('media').setDescription('Image to blur').setRequired(true)
        )
        .addNumberOption(opt =>
...
const invert = {
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(opt =>
            opt.setName('media').setDescription('Image to invert').setRequired(true)
        ),
    async execute(interaction) {
        await handleMediaCommand(interaction, {
            allowImage: true, allowVideo: false,
...
const rotate = {
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(opt =>
            opt.setName('media').setDescription('Image to rotate').setRequired(true)
        )
...
const flip = {
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(opt =>
            opt.setName('media').setDescription('Image to flip').setRequired(true)
        ),
    async execute(interaction) {
        await handleMediaCommand(interaction, {
            allowImage: true, allowVideo: false,
...
const flop = {
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(opt =>
            opt.setName('media').setDescription('Image to flop').setRequired(true)
        ),
    async execute(interaction) {
        await handleMediaCommand(interaction, {
            allowImage: true, allowVideo: false,
...
const resize = {
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(opt =>
            opt.setName('media').setDescription('Image to resize').setRequired(true)
        )
        .addIntegerOption(opt =>
...
const grayscale = {
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(opt =>
            opt.setName('media').setDescription('Image to desaturate').setRequired(true)
        ),
    async execute(interaction) {
        await handleMediaCommand(interaction, {
            allowImage: true, allowVideo: false,
...
const deepfry = {
    data: new SlashCommandBuilder()
        ...
        .addAttachmentOption(opt =>
            opt.setName('media').setDescription('Image to deep fry').setRequired(true)
        ),
    async execute(interaction) {
        await handleMediaCommand(interaction, {
            allowImage: true, allowVideo: false,
